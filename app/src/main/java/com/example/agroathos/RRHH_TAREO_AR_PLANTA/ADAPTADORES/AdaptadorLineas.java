...
public class AdaptadorLineas extends ArrayAdapter<E_Lineas> {

    public AdaptadorLineas(@NonNull Context context, ArrayList<E_Lineas> lotesArrayList) {
    ...
    private View view(int position, View convertView, ViewGroup parent){
        ...
        E_Lineas e_lineas = getItem(position);

        tvCultivo.setText(e_lineas.getNombre());
    ...
    private View viewInicial(int position, View convertView, ViewGroup parent){
        ...
        tvCultivoInicial.setText(e_lineas.getNombre());
