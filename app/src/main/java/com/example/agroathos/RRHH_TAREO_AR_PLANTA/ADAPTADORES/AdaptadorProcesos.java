...
public class AdaptadorProcesos extends ArrayAdapter<E_Procesos> {

    public AdaptadorProcesos(@NonNull Context context, ArrayList<E_Procesos> lotesArrayList) {
    ...
    private View view(int position, View convertView, ViewGroup parent){
        ...
        E_Procesos e_procesos = getItem(position);

        tvCultivo.setText(e_procesos.getNombre());
    ...
    private View viewInicial(int position, View convertView, ViewGroup parent){
        ...
        tvCultivoInicial.setText(e_procesos.getNombre());
