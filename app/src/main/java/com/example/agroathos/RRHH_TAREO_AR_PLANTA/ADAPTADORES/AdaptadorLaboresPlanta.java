...
public class AdaptadorLaboresPlanta extends ArrayAdapter<E_Labores_Planta> {

    public AdaptadorLaboresPlanta(@NonNull Context context, ArrayList<E_Labores_Planta> lotesArrayList) {
    ...
    private View view(int position, View convertView, ViewGroup parent){
        ...
        E_Labores_Planta e_labores_planta = getItem(position);

        tvCultivo.setText(e_labores_planta.getNombre());
    ...
    private View viewInicial(int position, View convertView, ViewGroup parent){
        ...
        tvCultivoInicial.setText(e_labores_planta.getNombre());
