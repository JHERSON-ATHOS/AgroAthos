...
public class AdaptadorActividades extends ArrayAdapter<E_Actividades> {

    public AdaptadorActividades(@NonNull Context context, ArrayList<E_Actividades> lotesArrayList) {
    ...
    private View view(int position, View convertView, ViewGroup parent){
        ...
        E_Actividades e_actividades = getItem(position);

        tvCultivo.setText(e_actividades.getNombre());
    ...
    private View viewInicial(int position, View convertView, ViewGroup parent){
        ...
        tvCultivoInicial.setText(e_actividades.getNombre());
