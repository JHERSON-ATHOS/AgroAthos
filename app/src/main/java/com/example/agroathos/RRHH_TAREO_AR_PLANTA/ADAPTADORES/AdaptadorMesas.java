...
public class AdaptadorMesas extends ArrayAdapter<E_Mesas> {

    public AdaptadorMesas(@NonNull Context context, ArrayList<E_Mesas> lotesArrayList) {
    ...
    private View view(int position, View convertView, ViewGroup parent){
        ...
        E_Mesas e_mesas = getItem(position);

        tvCultivo.setText(e_mesas.getNombre());
    ...
    private View viewInicial(int position, View convertView, ViewGroup parent){
        ...
        tvCultivoInicial.setText(e_mesas.getNombre());
