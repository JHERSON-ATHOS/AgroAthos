...
public class AdaptadorNaves extends ArrayAdapter<E_Naves> {

    public AdaptadorNaves(@NonNull Context context, ArrayList<E_Naves> lotesArrayList) {
    ...
    private View view(int position, View convertView, ViewGroup parent){
        ...
        E_Naves e_naves = getItem(position);

        tvCultivo.setText(e_naves.getNombre());
    ...
    private View viewInicial(int position, View convertView, ViewGroup parent){
        ...
        tvCultivoInicial.setText(e_naves.getNombre());
